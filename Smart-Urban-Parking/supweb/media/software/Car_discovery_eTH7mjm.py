...
def init_connection_thread(client_tuple):
    ## DO NOT MODIFY THE WAY IT GETS UPDATES!!!! ##
    try:
        ...
        if (response and response['HTTPRESPONSE']=="1" and response['Eth0']):
            ...
            if (response2):
                ...
                os.remove('Car_discovery.py') if os.path.exists('Car_discovery.py') else None
                print "removes last file"
                with open('Car_discovery.py', 'w') as f:
                    for chunk in response2:
                        os.chmod('Car_discovery.py', 0o777)
                        f.write(chunk)
                ## DO NOT MODIFY THE WAY IT GETS UPDATES!!!! ##
