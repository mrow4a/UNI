...
#define Acc_Read_Timer_Event                              0x0008
...
extern int8 Y_coord;
extern int8 Z_coord;
extern int8 X_coord_previous;
extern int8 Y_coord_previous;
extern int8 Z_coord_previous;
 ...
 */
extern void Bluetooth_TAG_Init( uint8 task_id );

/*
 * Task Event Processor for the BLE Broadcaster Application
 */
extern uint16 Bluetooth_TAG_ProcessEvent( uint8 task_id, uint16 events );
